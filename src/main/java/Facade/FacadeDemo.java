...
/**
 * Created by jjohnson on 1/20/2016.
 *
 * Facade pattern
 */

// Using objects passed to constructors to extend functionality
...
class Point {
    ...
    public void rotate(int angle, Point o) {
        ...
        double a = Double.parseDouble( str.substring(i+1, str.length()));
...
public class FacadeDemo {
    public static void main(String[] args) {
        ...
        // can implement facade methods through objects passed to constructors
